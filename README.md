...
所以，我不能保证内容的绝对权威性和正确性，仅仅只是提供一些参考和视角，当然，一有时间我会尽量及时更新文章的内容，删掉一些过时的东西。   
对于前端领域新入行的朋友，我的建议是买几本权威的书籍系统地学习一下，认真研读 MDN 文档，多动手多尝试。   

从事软件开发行业，已经有10个年头了，写总结文章也逐渐发展成我个人的一大爱好。    
